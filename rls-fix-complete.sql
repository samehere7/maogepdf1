...
-- 文件: rls-fix-complete.sql
-- 创建时间: 2025-06-23
-- 说明: 此脚本修复所有RLS权限问题并创建Plus状态更新函数
...
WHERE schemaname = 'public' 
  AND tablename IN ('user_profiles', 'plus', 'user_daily_quota')
...
WHERE routine_schema = 'public' 
  AND routine_name = 'update_user_plus_status';